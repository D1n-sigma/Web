...
<html lang="en">
    ...
    <body>
        <section id="header">
            ...
            <div>
                <ul id="navbar">
                    ...
                    <li><a clas="active" href="shop.html">Shop</a></li>
        ...
        <section id="page-header">
            <h2>#BeGentle</h2>
            <p>Save more with cupons & up to 60% off!</p>
        </section>
        ...
        <section id="product1" class="section-p1">
            <div class="pro-container">
                <div class="pro" onclick="window.location.href='sproduct.html';">
                    ...
                    <div class="des">
                        <span>Davidson</span>
                        <h5>Harley-Davidson 2024 Nightster Special Motorcycle Model</h5>
                        <div class="star">
                ...
                <div class="pro" onclick="window.location.href='sproduct2.html';">
                    ...
                    <div class="des">
                        <span>Davidson</span>
                        <h5>Harley-Davidson Forty-Eight</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro" onclick="window.location.href='sproduct3.html';">
                    ...
                    <div class="des">
                        <span>Davidson</span>
                        <h5>Harley-Davidson Iron 883</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro" onclick="window.location.href='sproduct4.html';">
                    ...
                    <div class="des">
                        <span>Davidson</span>
                        <h5>Harley-Davidson Livewire</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro" onclick="window.location.href='sproduct5.html';">
                    ...
                    <div class="des">
                        <span>Davidson</span>
                        <h5>Harley-Davidson Low Rider S</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro" onclick="window.location.href='sproduct7.html';">
                    ...
                    <div class="des">
                        <span>Davidson</span>
                        <h5>Harley-Davidson Softail Standard3</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro" onclick="window.location.href='sproduct8.html';">
                    ...
                    <div class="des">
                        <span>Davidson</span>
                        <h5>Harley-Davidson Street Bob</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
